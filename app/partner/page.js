...
export default async function PartnerPage({ searchParams }) {
  ...
  if (status === "upcoming") {
    return (
      <OfferMessage
        ...
        body="Специалната QR отстъпка от 20% още не е активна. Дотогава билетите са на редовна цена."
      />
    );
  }
  ...
  if (status === "expired") {
    return (
      <OfferMessage
        ...
        body="QR отстъпката от 20% е спряна. Билети на редовна цена са налични на страницата за билети."
      />
    );
  }
  ...
  return (
    <PricingSection
      ...
      subheading="Същите билети за основното събитие, с 20% отстъпка."
