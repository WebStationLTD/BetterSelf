...
export const scheduleData = [
  ...
  },
  {
    id: 5,
    time: "11:00 - 11:30",
    title: "Можем ли да препрограмираме стареенето?",
    speaker: "Д-р Константин Маламов",
    location: "Главна зала",
    description:
      "Метаболитна медицина, хормонална оптимизация и новите инструменти за регенерация",
    type: "presentation",
  },
  {
    id: 6,
  ...
  },
  {
    id: 14,
    time: "16:15 - 16:45",
    title: "От информация към трансформация: Как да изпълниш потенциала си",
    speaker: "Моузес Налока",
    location: "Главна зала",
    video: "/videos/moses-naloka-reel.mp4",
    description:
      "В свят, обсебен от данни, протоколи и оптимизация, съществува един скрит фактор, който определя дали усилията ти се превръщат в пробив, или остават само знание: пропастта между това да знаеш какво да правиш и действително да го направиш. Олимпийският треньор Моузес Налока — човекът, който изведе Ивет Горанова до първия златен олимпийски медал за България от 13 години — представя Reframance: Performance Transformation, липсващата връзка между информацията и реалната промяна. Трайната трансформация не идва от това да мислиш различно. Тя идва от това да действаш различно.",
    type: "presentation",
  },
  {
    id: 15,
    ...
    speaker:
      "Водещ: Мариан Морфис | Мария Варсанова (Biohacking.bg), Джулия Димитрова (Biohacking.bg), Д-р Гергана Иванова (екип на проф. Иво Петров), Ралица Узунова (Остеоестет • Фейс Фитнес), Д-р Мерилин Иванова (Mamaland Sofia), Венеса Мутафчиева (Touch & Care Center), Петър Петров (VAYA Beach Resort)",
    location: "Главна зала",
