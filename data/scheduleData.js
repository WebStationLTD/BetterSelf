...
export const scheduleData = [
  ...
  },
  {
    ...
    speaker:
      "Мирослав Тошкин (MD CAPITAL), Gary Andrew Rhodes (Screen My Bones®), Биляна Маринова (Dr. Bastet), Биорезонанс, Gregor Sideris (A&G Luxury Boutique)",
    location: "Главна зала",
    description:
  ...
  },
  {
    ...
    speaker:
      "Мариана Атанасова, Мария Варсанова (Biohacking.bg), Джулия Димитрова (Biohacking.bg), Д-р Гергана Иванова (екип на проф. Иво Петров), Ралица Узунова (Остеоестет • Фейс Фитнес)",
    location: "Главна зала",
